...
int SSL_CTX_OPENSSL_set_tlsext_max_fragment_length(SSL_CTX_OPENSSL *ctx, uint8_t mode);
int SSL_set_tlsext_max_fragment_length(SSL_OPENSSL *ssl, uint8_t mode);

# define TLSEXT_MAXLEN_host_name 255

__owur const char *SSL_get_servername(const SSL_OPENSSL *s, const int type);
__owur int SSL_get_servername_type(const SSL_OPENSSL *s);
/*
 ...
 * 0 or -1 otherwise.
 */
__owur int SSL_export_keying_material(SSL_OPENSSL *s, unsigned char *out, size_t olen,
 ...
 */
__owur int SSL_export_keying_material_early(SSL_OPENSSL *s, unsigned char *out,
                                            size_t olen, const char *label,
                                            size_t llen,
                                            const unsigned char *context,
                                            size_t contextlen);

int SSL_get_peer_signature_type_nid(const SSL_OPENSSL *s, int *pnid);

int SSL_get_sigalgs(SSL_OPENSSL *s, int idx,
                    int *psign, int *phash, int *psignandhash,
                    unsigned char *rsig, unsigned char *rhash);

int SSL_get_shared_sigalgs(SSL_OPENSSL *s, int idx,
                           int *psign, int *phash, int *psignandhash,
                           unsigned char *rsig, unsigned char *rhash);

__owur int SSL_check_chain(SSL_OPENSSL *s, X509 *x, EVP_PKEY *pk, STACK_OF(X509) *chain);
...
# define SSL_CTX_OPENSSL_set_tlsext_servername_callback(ctx, cb) \
        SSL_CTX_OPENSSL_callback_ctrl(ctx,SSL_CTRL_SET_TLSEXT_SERVERNAME_CB,\
                (void (*)(void))cb)
...
# define SSL_CTX_OPENSSL_set_tlsext_servername_arg(ctx, arg) \
        SSL_CTX_OPENSSL_ctrl(ctx,SSL_CTRL_SET_TLSEXT_SERVERNAME_ARG,0,arg)

# define SSL_CTX_OPENSSL_get_tlsext_ticket_keys(ctx, keys, keylen) \
        SSL_CTX_OPENSSL_ctrl(ctx,SSL_CTRL_GET_TLSEXT_TICKET_KEYS,keylen,keys)
# define SSL_CTX_OPENSSL_set_tlsext_ticket_keys(ctx, keys, keylen) \
        SSL_CTX_OPENSSL_ctrl(ctx,SSL_CTRL_SET_TLSEXT_TICKET_KEYS,keylen,keys)

# define SSL_CTX_OPENSSL_get_tlsext_status_cb(ssl, cb) \
        SSL_CTX_OPENSSL_ctrl(ssl,SSL_CTRL_GET_TLSEXT_STATUS_REQ_CB,0,(void *)cb)
# define SSL_CTX_OPENSSL_set_tlsext_status_cb(ssl, cb) \
        SSL_CTX_OPENSSL_callback_ctrl(ssl,SSL_CTRL_SET_TLSEXT_STATUS_REQ_CB,\
                (void (*)(void))cb)

# define SSL_CTX_OPENSSL_get_tlsext_status_arg(ssl, arg) \
        SSL_CTX_OPENSSL_ctrl(ssl,SSL_CTRL_GET_TLSEXT_STATUS_REQ_CB_ARG,0,arg)
# define SSL_CTX_OPENSSL_set_tlsext_status_arg(ssl, arg) \
        SSL_CTX_OPENSSL_ctrl(ssl,SSL_CTRL_SET_TLSEXT_STATUS_REQ_CB_ARG,0,arg)

# define SSL_CTX_OPENSSL_set_tlsext_status_type(ssl, type) \
        SSL_CTX_OPENSSL_ctrl(ssl,SSL_CTRL_SET_TLSEXT_STATUS_REQ_TYPE,type,NULL)

# define SSL_CTX_OPENSSL_get_tlsext_status_type(ssl) \
        SSL_CTX_OPENSSL_ctrl(ssl,SSL_CTRL_GET_TLSEXT_STATUS_REQ_TYPE,0,NULL)

# define SSL_CTX_OPENSSL_set_tlsext_ticket_key_cb(ssl, cb) \
        SSL_CTX_OPENSSL_callback_ctrl(ssl,SSL_CTRL_SET_TLSEXT_TICKET_KEY_CB,\
                (void (*)(void))cb)
